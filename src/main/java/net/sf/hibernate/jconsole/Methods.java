...
public enum Methods {
	...
	getEntityStatistics(HibernateStatistics, Names.getEntityStatistics, String.class.getName()),
	getCollectionStatistics(HibernateStatistics, Names.getCollectionStatistics, String.class.getName()),
	getSecondLevelCacheStatistics(HibernateStatistics, Names.getSecondLevelCacheStatistics, String.class.getName()),
	getQueryStatistics(HibernateStatistics, Names.getQueryStatistics, String.class.getName()),;
