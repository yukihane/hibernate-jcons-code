...
import static net.sf.hibernate.jconsole.util.HibernateJmxBinding.DEFAULT_BEAN_NAME;
...
public enum Names {
	...
	HibernateStatistics(Type.mbean, System.getProperty("hibernate.mbean", DEFAULT_BEAN_NAME)),
